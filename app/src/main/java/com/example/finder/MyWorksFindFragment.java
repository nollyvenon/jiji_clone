...
public class MyWorksFindFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = linearLayout.findViewById(R.id.my_work_finds);
        FindsRecyclerViewAdapter adapter = new FindsRecyclerViewAdapter(getContext(), showFinds());
